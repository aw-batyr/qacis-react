...
`
  ...
  function qo(e, t) {
    switch ((Oe(gl, t), Oe(vl, e), Oe(qt, yl), (e = t.nodeType), e)) {
      case 9:
      case 11:
  ...
  var _i = {
    ...
    Id = {
      ...
      useTransition: function () {
        var e = Cs(!1),
          t = e[0];
        return (e = zd.bind(null, e[1])), (bt().memoizedState = e), [t, e];
      },
    ...
    switch ((Bo(t), t.tag)) {
      ...
      case 5:
        ...
        if (((n = t.type), e !== null && t.stateNode != null))
          ...
          if (((e = rr(qt.current)), vi(t))) {
            (r = t.stateNode), (n = t.type);
            var o = t.memoizedProps;
            switch (((r[Zt] = t), (r[pl] = o), (e = (t.mode & 1) !== 0), n)) {
              case "dialog":
      ...
      case 6:
        if (e && t.stateNode != null) of(e, t, e.memoizedProps, r);
          ...
          if (((n = rr(gl.current)), rr(qt.current), vi(t))) {
            if (
              ((r = t.stateNode),
              (n = t.memoizedProps),
              (r[Zt] = t),
  ...
  function pf(e, t) {
    ...
    switch (e.tag) {
      ...
      case 15:
        ...
        break;
      case 1:
        Kt(t, e), en(e), r & 512 && n !== null && jr(n, n.return);
        break;
      case 5:
        if (
          (Kt(t, e),
      ...
      case 3:
        if (
          (Kt(t, e), en(e), r & 4 && n !== null && n.memoizedState.isDehydrated)
        )
          try {
            nl(t.containerInfo);
          } catch (ee) {
...
function zp(i, u, a = !1) {
  ...
  for (let v = 0; v < c.length; ++v) {
    ...
    Object.assign(f, O.params),
      h.push({
        params: f,
        pathname: tn([d, O.pathname]),
        pathnameBase: jp(tn([d, O.pathnameBase])),
        route: L,
      }),
      O.pathnameBase !== "/" && (d = tn([d, O.pathnameBase]));
  }
  return h;
}
function no(i, u) {
...
function Ju(i, u, a, c, f, d) {
  ...
  return (
    a !== "/" && (g.pathname = g.pathname === "/" ? a : tn([a, g.pathname])),
    Vn(g)
  );
}
function Vf(i, u, a) {
...
var Jt = T.createContext({ outlet: null, matches: [], isDataRoute: !1 });
...
function hh(i, { relative: u } = {}) {
  ...
  let { basename: a, navigator: c } = T.useContext(nn),
...
function mh() {
  let { isDataRoute: i } = T.useContext(Jt);
  return i ? Nh() : yh();
}
function yh() {
  Se(
  ...
  let i = T.useContext(dr),
    { basename: u, navigator: a } = T.useContext(nn),
    { matches: c } = T.useContext(Jt),
    { pathname: f } = pr(),
  ...
  return (
    ...
    T.useCallback(
      (g, S = {}) => {
        ...
        i == null &&
          u !== "/" &&
          (D.pathname = D.pathname === "/" ? u : tn([u, D.pathname])),
...
function gh(i) {
  let u = T.useContext(Jt).outlet;
  return u && T.createElement(vh.Provider, { value: i }, u);
}
function wm() {
  let { matches: i } = T.useContext(Jt),
    u = i[i.length - 1];
  return u ? u.params : {};
}
function Ul(i, { relative: u } = {}) {
  let { matches: a } = T.useContext(Jt),
    { pathname: c } = pr(),
...
function wh(i, u, a, c) {
  ...
  let { navigator: f } = T.useContext(nn),
    { matches: d } = T.useContext(Jt),
    h = d[d.length - 1],
    v = h ? h.params : {},
    g = h ? h.pathname : "/",
    S = h ? h.pathnameBase : "/",
...
function xh({ routeContext: i, match: u, children: a }) {
  ...
  return (
    ...
    T.createElement(Jt.Provider, { value: i }, a)
  );
}
...
function mm(i, { relative: u } = {}) {
  let { basename: a } = T.useContext(nn),
    c = T.useContext(Jt);
  ...
  return (
    ...
    a !== "/" && (d.pathname = d.pathname === "/" ? a : tn([a, d.pathname])),
    Vn(d)
  );
}
function ym(i, u = {}) {
