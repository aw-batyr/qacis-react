...
import { Participant } from "@/services/types/participants.type";
...
export const ParticipantsItem: FC<Props> = ({
  className,
  index,
  name,
  image,
  ...
  return (
    <>
      <div
        key={index}
        className={cn(
          "flex border-b sm:hidden py-2 border-outline_v",
          className
        )}
      >
        <div className="flex flex-1 flex-col items-start gap-4">
          <div className="flex items-center gap-3 w-full">
            <h3 className="text-xs normal flex-[0_0_30%]">
              {lang === "ru" ? "Название компании" : "Company name"}:
            </h3>
            <h4 className="text-xs w-full flex-[0_0_30%]">{name}</h4>
          </div>
          ...
          <div className="flex items-center gap-3 ">
            <div className="flex items-center gap-1 ">
              ...
              <div className="flex items-center flex-[0_0_30%] gap-2">
